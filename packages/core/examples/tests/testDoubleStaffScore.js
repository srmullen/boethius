export default function testDoubleStaffScore (scored) {
    var n = scored.note;
    var r = scored.rest;
    // create lines
    ...
    // create staves
    var system1 = scored.system({startsAt: 0, duration: {measure: 6}, lineHeights: [0, 200]});
    var system2 = scored.system({startsAt: fourfour.getDurationTime({measure: 6}), duration: {measure: 6}});

...
describe("Legato", () => {
    describe("groupItems", () => {
        ...
        it("should group different legato items into different arrays", () => {
            ...
            expect(groupItems([n1, n2, n3, n4, n5])).to.eql([[n1, n2], [n3, n4, n5]]);
        });
        ...
        it("should remove notes that don't have legato IDs", () => {
            ...
            const n7 = n({pitch: "b4"});
            expect(groupItems([n1, n2, n3, n4, n5, n6, n7])).to.eql([[n1, n2], [n4, n5, n6]]);
        });
    });
});

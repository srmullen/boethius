var examples = {
    ...
    testBarlineWithoutBreaks: () => {
        ...
        var v2 = scored.voice({name: "v2"}, [
            r({value: 2}), r({value: 4}), n({value: 4}), n({value: 4})
        ]);
        ...
        var v4 = scored.voice({name: "v4"}, [
            r({value: 2}), r({value: 4}), r({value: 8}), r({value: 16}), n({value: 16}), n({value: 16})
        ]);

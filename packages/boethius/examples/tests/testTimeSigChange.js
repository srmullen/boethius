export default function testTimeSigChange (scored) {
    ...
    var system1 = scored.system({duration: {measure: 6}, startsAt: 0, lineHeights: [0, 200]});
    const startsAt = 1 + (5 * 0.75);
    var system2 = scored.system({duration: {measure: 6}, startsAt: startsAt});

    var score = scored.score(
      {length: 1000, systemHeights: [0, 150]},
      [fourfour, threefour, page0, system1, system2, trebleLine]);

...
/* unused harmony export sharp */
/* unused harmony export ionian */
/* unused harmony export dorian */
/* unused harmony export phrygian */
/* unused harmony export lydian */
/* unused harmony export mixolydian */
/* unused harmony export aeolian */
/* unused harmony export locrian */
...
/* unused harmony export low */
/* unused harmony export high */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return lower; });
/* unused harmony export raise */
...
function reverse (array) {
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.reduceRight(array, (acc, n) => {
        acc.push(n);
        return acc;
    }, []);
}
...
function sumFrom (series, n) {
    if (Math.floor(n) !== n) {
        ...
        let rseries = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(reverse(series), n => 0 - n);
        return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.sum(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.range(Math.abs(n)), (i) => rseries[i % rseries.length]));
    } else if (n >= 0) {
        return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.sum(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.range(n), (i) => series[i % series.length]));
    }
}

function create (scale) {
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.partial(sumFrom, scale);
}

function mode (scale, n, scaleLenth=7) {
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.compose((x) => x - scale(n), scale, from(n));
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_chalk__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_chalk___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_chalk__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_commander__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_commander___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_commander__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_main__ = __webpack_require__(20);
...
__WEBPACK_IMPORTED_MODULE_3_commander___default.a
    .version("0.0.1")
...
const outdir = __WEBPACK_IMPORTED_MODULE_3_commander___default.a.outdir || './';

// If outdir doesn't exist then create it.
if (!__WEBPACK_IMPORTED_MODULE_0_fs___default.a.existsSync(outdir)) {
    __WEBPACK_IMPORTED_MODULE_0_fs___default.a.mkdirSync(outdir);
}

if (__WEBPACK_IMPORTED_MODULE_3_commander___default.a.file) {
    const bth = __WEBPACK_IMPORTED_MODULE_0_fs___default.a.readFileSync(__WEBPACK_IMPORTED_MODULE_3_commander___default.a.file, 'utf8');
    const {name} = __WEBPACK_IMPORTED_MODULE_1_path___default.a.parse(__WEBPACK_IMPORTED_MODULE_3_commander___default.a.file);
...
var spawn = __webpack_require__(19).spawn;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lang_lang__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lang_lang___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lang_lang__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__time_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__palestrina__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__NoteNode__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RestNode__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ChordNode__ = __webpack_require__(32);
...
function compile (program) {
    __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.voices = {};
    __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.chordSymbols = [];
    __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.vars = {};
    __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.NoteNode = __WEBPACK_IMPORTED_MODULE_3__NoteNode__["a" /* default */];
    __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.RestNode = __WEBPACK_IMPORTED_MODULE_4__RestNode__["a" /* default */];
    __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.ChordNode = __WEBPACK_IMPORTED_MODULE_5__ChordNode__["a" /* default */];
    __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.parsePitch = __WEBPACK_IMPORTED_MODULE_2__palestrina__["a" /* pitch */].parsePitch;

    const parsed = __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].parse(program);

    for (let voice in __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.voices) {
        if (__WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.voices.hasOwnProperty(voice)) {
            Object(__WEBPACK_IMPORTED_MODULE_1__time_js__["a" /* calculateAndSetTimes */])(__WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.voices[voice]);
        }
    }

    return {voices: __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.voices, chordSymbols: __WEBPACK_IMPORTED_MODULE_0__lang_lang__["parser"].yy.chordSymbols};
}
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = calculateAndSetTimes;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fraction_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fraction_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_fraction_js__);
...
function calculateDuration (item) {
	...
	const tuplet = s ? new __WEBPACK_IMPORTED_MODULE_0_fraction_js___default.a(s[0], s[1]) : null;
	const dots = item.props.dots || 0;

	let dur = new __WEBPACK_IMPORTED_MODULE_0_fraction_js___default.a(1, item.props.value || 4);
...
function calculateAndSetTimes (items, offset=0) {
    return items.reduce((acc, item) => {
        ...
        if (previousItem) {
            item.props.time = __WEBPACK_IMPORTED_MODULE_0_fraction_js___default()(previousItem.props.time).add(calculateDuration(previousItem)).add(offset).valueOf();
        } else {
            item.props.time = 0;
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scale__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__melody__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chord__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pitch__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__live__ = __webpack_require__(29);
/* unused harmony reexport scale */
/* unused harmony reexport melody */
/* unused harmony reexport chord */
/* unused harmony reexport live */
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_3__pitch__; });
"format es6";
...
"use strict";
/* unused harmony export phrase */
/* unused harmony export accompany */
/* unused harmony export having */
/* unused harmony export is */
/* unused harmony export all */
/* unused harmony export where */
/* unused harmony export wherever */
/* unused harmony export but */
/* unused harmony export times */
/* unused harmony export then */
/* unused harmony export mapthen */
/* unused harmony export after */
/* unused harmony export bpm */
/* unused harmony export duration */
/* unused harmony export rhythm */
/* unused harmony export tempo */
/* unused harmony export accelerando */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fraction_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fraction_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_fraction_js__);
"format es6";
...
function calculateTimes (phrase) {
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.reduce(phrase, (acc, note) => {
        let previous = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.last(acc);
        if (previous) {
            note.time = new __WEBPACK_IMPORTED_MODULE_1_fraction_js___default.a(previous.duration).add(previous.time);
        } else {
            note.time = 0;
        }
...
function accompany (...phrases) {
	return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.sortBy(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.flatten(phrases), n => n.time);
}

/* Delay notes by wait */
// neccessary?
function after (wait, notes) {
    const time = new __WEBPACK_IMPORTED_MODULE_1_fraction_js___default.a(wait);
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(notes, (note) => {
...
function having (prop, values, phrase) {
	return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(phrase, (event, i) => {
		var property = {};
		property[prop] = values[i];
		return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.assign({}, event, property);
	});
}
...
function where (prop, fn, phrase) {
	...
	return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(phrase, (event) => {
		let property = {};
...
function wherever (applicable, k, f, notes) {
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(notes, (note) => {
        let n = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.clone(note);
        if (applicable(n)) {
            n[k] = f(n[k]);
        }
        return n;
...
function but (start, end, variation, phrase) {
	let variationObject = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.mapKeys(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.take(variation, end - start), (val, k) => +k + start);
	return calculateTimes(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.assign([], phrase, variationObject));
}

/* Reapeats notes n times */
function times (n, phrase) {
	return calculateTimes(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.flatten(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.times(n, () => __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(phrase, __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.clone))));
}

let mapClone = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.partialRight(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map, __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.clone);
...
function bpm (tempo) {
    return (beat) => {
		let time = new __WEBPACK_IMPORTED_MODULE_1_fraction_js___default.a(beat, tempo);
...
function duration (notes) {
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.sum(notes, n => n.duration);
}
...
function rhythm (durations=[]) {
    return phrase(durations, __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.times(durations.length, () => null));
}
...
function tempo (timing, notes) {
	return where("time", timing, notes.map((note) => {
		let clone = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.clone(note);
...
"use strict";
/* unused harmony export triad */
/* unused harmony export seventh */
/* unused harmony export ninth */
/* unused harmony export eleventh */
/* unused harmony export thirteenth */
/* unused harmony export root */
/* unused harmony export inversion */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
...
function root (chord, tonic) {
    let rootChord = {},
        fromTonic = Object(__WEBPACK_IMPORTED_MODULE_1__scale__["a" /* from */])(tonic);
    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(chord, (v, k) => {
...
function inversion (chord, n) {
    let stable = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.take(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.keys(triad), n),
        lowered = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.difference(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.keys(chord), stable);

    let invertedChord = {};
    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(stable, (k) => {
        invertedChord[k] = chord[k];
    });

    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(lowered, (k) => {
        invertedChord[k] = Object(__WEBPACK_IMPORTED_MODULE_1__scale__["b" /* lower */])(chord[k]);
    });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["parsePitch"] = parsePitch;
/* harmony export (immutable) */ __webpack_exports__["noteInfo"] = noteInfo;
/* harmony export (immutable) */ __webpack_exports__["noteToMidi"] = noteToMidi;
/* harmony export (immutable) */ __webpack_exports__["midiToHz"] = midiToHz;
/* harmony export (immutable) */ __webpack_exports__["noteToHz"] = noteToHz;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
...
function noteInfo ({pitchClass, octave}) {
...
function noteToMidi (note) {
    if (Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["isString"])(note)) {
...
"use strict";
/* unused harmony export createPart */
/* unused harmony export playNote */
...
/* harmony default export */ __webpack_exports__["a"] = (NoteNode);
...
/* harmony default export */ __webpack_exports__["a"] = (RestNode);
...
/* harmony default export */ __webpack_exports__["a"] = (ChordNode);
